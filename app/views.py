from . import app, USERS, models, EXPRS
...
@app.get("/user/<int:user_id>")  # доступ к пользователю через id
...
@app.get("/math/expression/<int:expr_id>")
def get_expr(expr_id):
    # todo: check the validity of expr_id
